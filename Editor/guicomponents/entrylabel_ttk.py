...
class EntryLabel(ttk.Frame):
    ...
    """
    def __init__(self, parent, anchor=tk.CENTER, background=None, borderwidth=None, compound=None, cursor=None,
                 ...
                 entry_style=None, label_style=None, label_justify=tk.CENTER, entry_justify=tk.CENTER):
        ...
        self.entry.pack(expand=tk.YES, fill=tk.X)

...
class EntryLabel(Frame):
    ...
    def getArgs(self,kwargs):
        ...
        e_height, e_width, var, vcmd,val = keyExtract(('e_height','e_width','textvariable','vcmd','validate'),kwargs)
        f_dict = {'height':f_height,'width':f_width}
        e_dict = {'height':e_height,'width':e_width,'textvariable':var,'vcmd':vcmd,'validate':val}

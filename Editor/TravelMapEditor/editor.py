...
class TravelEditorGUI(ttk.Frame):
    def __init__(self, parent=None):
        ...
        top.pack(expand=tk.YES, fill=tk.BOTH, padx=10)
        mid.pack(expand=tk.YES, fill=tk.BOTH, padx=10)
        bot.pack(expand=tk.YES, fill=tk.BOTH, padx=10)
        ...
        self.entry_spawn.pack(expand=tk.YES, fill=tk.X,  side=tk.LEFT, padx=(5, 0), pady=10)
